onegreek.controller('registerController', function($scope, $state, $timeout, $interval, authService, userService, universityService, organizationService, smsService) {
    ...
    $scope.submitPhone = function() {
        if($scope.user.phone>999999999 && $scope.user.phone<10000000000) {
            $scope.showRedQuestion = false;
            smsService.sendSMS($scope.user.phone, function (res) {
